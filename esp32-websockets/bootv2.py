...
# dinamyc detector sensor included
# a diferencia de la version boot.py esta version incluye deteccion dinamica de sensores en todo momento
...
# ⬇️ NUEVA FUNCIÓN: Detección dinámica de sensores
def detect_sensors():
...
def main():
    ...
    last_detect = time.ticks_ms()  # ⬅️ NUEVO: Timer para detección dinámica
